...
const desiredMargin = 40; // Set the desired margin size
  ...
  return (
    <>
      ...
      <FlatList
        ...
        style={{ flexGrow: 0, width: 275, left: 45 }} // Prevents the FlatList from stretching
      />
      {/* Join */}
      {!isJoined ? (
...
const styles = StyleSheet.create({
  ...
  headerTitle: {
    ...
    position: 'absolute',
    left: 120, // Distance from the left edge of the card
  },
  imagesContainer: {
    flexDirection: "row",
